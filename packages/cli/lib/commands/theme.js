...
function theme(siteDir, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var _a, verbose, nodeScssCmd, scssCmdOpts, amisScss, libScss, destStyles, siteScss, hasSiteScss, relativeDir, importer, includePaths, resultFlag, logSuccess, libCmd, siteCmd;
        return __generator(this, function (_b) {
            _a = options.verbose, verbose = _a === void 0 ? false : _a;
            ...
            // build siteScss
            if (hasSiteScss) {
                siteCmd = nodeScssCmd + " " + siteScss + " -o " + destStyles + " " + importer + " " + includePaths([
                    amisScss,
                    libScss,
                ]);
                // console.log('siteCmd===>\n', siteCmd, '\n')
