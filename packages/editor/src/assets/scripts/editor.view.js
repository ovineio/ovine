...
// ovine: rplaceholder: "http://" => placeholder: ""
;!function(e, t) {
...
function(e, t, a) {
	...
	o = function(e) {
		function t() {
			var t = null !== e && e.apply(this, arguments) || this;
			return t.rendererName = "steps",
			t.$schema = "/schemas/StepsSchema.json",
			t.name = "Steps 步骤条",
			t.icon = "fa fa-forward",
			t.description = "Steps 步骤条",
			t.tags = ["展示"],
			t.scaffold = {
				type: "steps",
				value: 1,
