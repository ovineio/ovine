...
function(e, t, a) {
    ...
    var v = function() {
        ...
        e.prototype.addChild = function(e, t, a, l, i, r) {
            ...
            return ! p.prevented && (o.insertSchema(p), this.trigger("after-insert", u), !0)
        },
...
function(e, t, a) {
    ...
    var n = a(0),
    l = a(5),
    i = n.__importDefault(a(47)),
    r = a(22),
    o = n.__importDefault(a(48)),
    s = n.__importDefault(a(29)),
    d = l.utils.guid,
...
function(e, t, a) {
    ...
    t.mockValue = void 0;
    var n = a(0).__importDefault(a(80));
...
function(e, t, a) {
    ...
    d = a(7),
    c = a(11),
    u = n.__importDefault(a(49)),
    p = n.__importDefault(a(30)),
    m = a(31),
    f = n.__importDefault(a(32)),
    h = a(9),
    g = a(12),
    b = function(e) {
        function t() {
...
function(e, t, a) {
    ...
    p = function(e) {
        function t() {
            ...
            t.props.manager.env), {
                notify: function(e, a) {
                    t.props.editable ? console.warn("[Notify]", e, a) : i.toast[e] ? i.toast[e](a, "error" === e ? "系统错误": "系统消息") : console.warn("[Notify]", e, a)
                },
                theme: t.props.theme,
                session: "preview-" + t.props.manager.id,
                rendererResolver: t.rendererResolver
            }), t.props.manager.env),
            t
        }
        return n.__extends(t, e),
...
function(e, t, a) {
    ...
    t.IFrameEditor = t.mountInIframe = t.CodeEditor = t.BasicEditor = t.RendererEditor = t.registerEditorPlugin = t.getSchemaTpl = t.BasePlugin = t.utils = t.MiniEditor = t.Editor = void 0;
    var n = a(0),
...
default,
    ...
    var c = n.__importDefault(a(175));
    t.MiniEditor = c.
default;
    var u = n.__importDefault(a(41));
    t.CodeEditor = u.
default;
    var p = n.__importDefault(a(38));
    t.IFrameEditor = p.
default;
    var m = a(32);
