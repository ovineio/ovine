...
export const themePath = `${srcDirName}/theme`
export const defaultPort = 7050

export const dllVendorPath = `${staticDirName}/${libName}/dll`
export const dllVendorFileName = 'vendor'
export const dllDirName = `${generatedDirName}/dll`
export const dllManifestName = `${dllDirName}/manifest.json`
export const dllAssetsName = `${dllDirName}/assets.json`
